                ...
                return (
                  <div className='' key={index}>
                    <div className='mb-6'>
                      ...
                      <p className='font-secondary leading-tight text-[17px]'>
                        {/* {description} */}
                        {description.map((line, lineIndex) => (
                          <p key={lineIndex} className='font-secondary leading-tight flex'>
                            <div className='bg-white w-1 h-1 rounded-full p-1 m-1.5 mr-2'/>{line}
                          </p>
                        ))}
                      </p>
