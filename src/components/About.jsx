      ...
      <div className="container mx-auto">
        <div className='flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen'>
          ...
          className='flex-1'>
            ...
            <p className='mb-6'>
              I am a new graduate with a background in Front-End Developer. <br /> I recently graduated from computer engineering chiang rai rajabhat university with a degree in bachelor of engineering. <br/> <p className='mb-3'/>
